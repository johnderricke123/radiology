...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <table id="membersTbl" class="table stripe row-border" cellspacing="0">
                ...
                <tbody>
                    <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><?php echo e($member->PatientID); ?></td>
                            <!-- <td><?php echo e($member->PatientNam); ?> </td> -->
                            <td><?php echo e($str = preg_replace('/[^A-Za-z0-9. -]/', ', ', $member->PatientNam )); ?></td>
                            <td><?php echo e($member->PatientBir); ?></td>
                            <td><?php echo e($member->PatientSex); ?></td>
                            <td><a href="<?php echo e(route('dicom.patient.studies', ['id' => $member->PatientID])); ?>" class="btn btn-outline-success btn-sm"><i class="fas fa-eye"></i></a></td>
                        </tr>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#search').on('input change', function(e){
            ...
            //     var newLink = `<?php echo e(URL::to('/')); ?>?`+(newParams.join('&'));
            //     history.pushState({}, "", newLink)
            // }else{
            //     if(searchTxt != ""){
            //         history.pushState({}, "", `<?php echo e(URL::to('/')); ?>?q=${encodeURIComponent(searchTxt)}`)
            //     }else{
            //         history.pushState({}, "", `<?php echo e(URL::to('/')); ?>`)
            //     }
            ...
            search_ajax = $.ajax({
                url:`<?php echo e(URL::to('/search/patient')); ?>?q=${searchTxt}`,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hch\resources\views/dicom/all_patient_list.blade.php ENDPATH**/ ?>