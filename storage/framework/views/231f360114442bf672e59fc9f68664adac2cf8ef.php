...
<p><?php echo $patientInfo ?: "no data"; ?></p>
            ...
            <form method="post" action="<?php echo e(route('patient.create')); ?>" enctype="multipart/form-data">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                     ...
                     <input type="text" class="form-control" id="dicomID" name="dicomID" value="<?php echo e($patientInfo ? $patientInfo->PatientID : ''); ?>">
                  </div>
                  <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                     <label for="inputEmail4">First Name<font color="red">*</font></label>
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                     <label for="inputAddress"><?php echo e(__('sentence.Patient Height')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hch\resources\views/patient/create.blade.php ENDPATH**/ ?>