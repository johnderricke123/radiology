...
<html lang="en">
   <head>
      ...
      <meta name="author" content="MilesIdea">
      <!-- CSRF Token -->
      <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
      <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests"> 
      <link rel="icon" type="image/png" href="<?php echo e(asset('img/favicon.png')); ?>">
      <title> HCH App- <?php echo $__env->yieldContent('title'); ?> </title>
    ...
    <link href="http://localhost/hch/public/dashboard/css/sb-admin-2.min.css" rel="stylesheet"  media="all">
    ...
    <link href="http://localhost/hch/public/css/print.css" rel="stylesheet" media="all">
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                  ...
                  <div class="sidebar-brand-text mx-3"><img src="<?php echo e(asset('img/doctor-logo.jpg')); ?>" class="img-fluid" ></div>
               </a>
...
<?php if(Auth::user()->name != "WORKSTATION"){?>
...
<?php } ?>
                        ...
                        <?php endif; ?>
<!-- ******************ALL REPORTS ADDED FEATURE****************** -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all patients')): ?>
                        <a class="collapse-item" href="<?php echo e(route('reports.all')); ?>"><?php echo e(__('sentence.All Reports')); ?></a>
                        <?php endif; ?>
<!-- ******************ALL REPORTS ADDED FEATURE****************** -->
                     </div>
                  </div>
               ...
               <!-- <li class="nav-item">
                  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDICOMPatient" aria-expanded="true" aria-controls="collapseTwo">
                  <i class="fas fa-fw fa-user-injured"></i>
                  <span><?php echo e(__('sentence.DICOM Patients')); ?></span>
                  </a>
                  <div id="collapseDICOMPatient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all patients')): ?>
                        <a class="collapse-item" href="<?php echo e(route('dicom.patient.all')); ?>"><?php echo e(__('sentence.DICOM Patients')); ?></a>
                        <?php endif; ?>
                     </div>
                  </div>
               </li> -->
               ...
               <?php if(Auth::user()->can('add patient')): ?>
                  ...
                  <div id="collapseDICOMPatient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all patients')): ?>
                        <a class="collapse-item" href="<?php echo e(route('dicom.patient.all')); ?>"><?php echo e(__('sentence.DICOM Patients')); ?></a>
                        <a class="collapse-item" href="<?php echo e(route('dicom.patient.all.list')); ?>"><?php echo e(__('sentence.DICOM All Patients')); ?></a>
                        <?php endif; ?>
                     </div>
                  </div>
               </li>
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>Copyright &copy; Powered by <a href="http://egcomputers2014.com/" target="_blank"> EG COMPUTER SOLUTIONS AND ENTERPRISES</a> <?php echo e(date('Y')); ?></span>
   ...
   <!-- Bootstrap core JavaScript-->
    <script src="<?php echo e(asset('dashboard/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
      ...
      <script src="<?php echo e(URL::asset('dashboard/js/gijgo.min.js')); ?>" type="text/javascript"></script>
...
</html><?php /**PATH C:\xampp\htdocs\hch\resources\views/layouts/master.blade.php ENDPATH**/ ?>