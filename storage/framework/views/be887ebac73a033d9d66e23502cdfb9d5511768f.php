...
?>
    <div class="card shadow mb-4">
            <div class="card-header py-3">
               <div class="row">
                    <div class="col-3">
                        <h6 class="m-0 font-weight-bold text-primary w-75 p-2"><img class="fa fa-grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" /> All DICOM Studies</h6>
                    </div>
                    <div class="col-6">
                    <form action="<?php echo e(route('dicom.patient.all')); ?>" method="get">
                        <!-- <div class="form-group row"> -->
                            <div class="input-group p-2">
                                ...
                                <div class="input-group-append"> <a href="<?php echo e(route('dicom.patient.all','filter=All')); ?> " class="btn btn-info">All</a></div>
                                <div class="input-group-append"> <a href="<?php echo e(route('dicom.patient.all')); ?> " class="btn btn-warning">Clear</a></div>
                    ...
                    <div class="col-3">
                        <form method="post" action="<?php echo e(route('search.dicom.patient')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="input-group p-2">
...
// $formattedTime12Hour = $carbonTime->format('g:i A');
                                ...
                                <td><label class="badge badge-primary-soft">
                                    <?php echo e(\Carbon\Carbon::parse($result->StudyDate)->format('M d Y')); ?> 
                                    <?php echo e(\Carbon\Carbon::parse($result->StudyTime)->format('H:i')); ?>
                                ...
                                <!-- <td><label class="badge badge-primary-soft">
                                    ...
                                    <td><a href="<?php echo e(route('patient.create', ['id' => $result->PatientID])); ?>"><?php echo e($str = preg_replace('/[^A-Za-z0-9. -]/', ', ', $patient_name )); ?></a></td>
                                    ...
                                    <td class="text-center"> 
                                            ...
                                            <?php if(Auth::user()->can('create appointment')): ?>
                                                    <form method="get" action="/view/dicom/patient/<?php echo e($result->PatientID); ?>">
                                                        <!-- <a href="/view/dicom/patient/<?php echo e($result->PatientID); ?>" class="btn btn-outline-success btn-sm"><i class="fa fa-edit"></i></a> -->
                                                        <input type="hidden" name="study_insta" value="<?php echo e($result->StudyInsta); ?>"/>
                                            ...
                                            <?php endif; ?>
                                                        <!-- <a class="btn btn-outline-primary btn-sm text-secondary" title="Enter Result" data-toggle="modal" id="mediumButton" data-target="#mediumModal"
                                                            data-attr="<?php echo e($result->PatientID); ?>">
                                                            <i class="fas fa-edit text-gray-300"></i>
                                                        </a> -->
                                                        <!-- <a class="btn btn-outline-primary btn-sm" onclick='window.open("http://xray.hchdgte.com/viewer?StudyInstanceUIDs=<?php echo e($result->StudyInsta); ?>",  "_blank", "width=1220, height=1200", "class=btn btn-outline-warning btn-sm", "title=View Study");' ><img class="fa grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" /> </a> -->
<!-- <a class="btn btn-outline-primary btn-sm" onclick='window.open("http://www.hchdgte.com/viewer?StudyInstanceUIDs=<?php echo e($result->StudyInsta); ?>",  "_blank", "width=1020, height=1200", "class=btn btn-outline-warning btn-sm", "title=View Study");' ><img class="fa grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" /> </a> -->
<!-- *********************TEMPORARY FIXED********************* -->
                                <?php if(request()->getHost() == "localhost:8000"): ?>
                                  <a class="btn btn-outline-secondary btn-sm" title="View Dicom" onclick='window.open("https://www.hchdgte.com/viewer?StudyInstanceUIDs=<?php echo e($result->StudyInsta); ?>",  "_blank", "width=720, height=1200", "class=btn btn-outline-warning btn-sm", "title=View Study");' ><img class="fa fa-grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" /> </a>
                                <?php endif; ?>
                                <?php if(request()->getHost() != "xray.hchdgte.com"): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(getenv("REMOTE_ADDR") != "192.168.254.157"): ?>
                                    <a href="http://localhost:5000/viewer?StudyInstanceUIDs=<?php echo e($result->StudyInsta); ?>" target="_blank" class="btn btn-outline-secondary btn-sm" title="View Dicom" ><img class="fa grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" /> </a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if(Auth::user()->can('create appointment')): ?>
                                  <a href="/download/dicom/folder/<?php echo e($result->PatientID); ?>" title="Download Dicom" class="btn btn-outline-warning btn-circle btn-sm"><i class="fa fa-download" aria-hidden="true"></i></a>                                
                                <?php endif; ?>

<!-- <a href="/view/dcm/file/<?php echo e($result->PatientID); ?>/<?php echo e($result->StudyInsta); ?>" class="btn btn-sm btn-primary">test</a> -->

<a class="btn btn-outline-secondary btn-sm" title="View Dicom" onclick='openPopup("<?php echo $result->StudyInsta; ?>",<?php echo $result->PatientID; ?>)' ><img class="fa grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" />te </a>
<a onclick='window.open("/view/dcm/file/<?php echo e($result->PatientID); ?>/<?php echo e($result->StudyInsta); ?>",  "_blank", "width=720, height=1200", "class=btn btn-outline-warning btn-sm", "title=View Study");' class="btn btn-outline-secondary btn-sm"> <img class="fa grey" width="16" src="<?php echo e(asset('webfonts/x-ray-solid.svg')); ?>" />12 </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hch\resources\views/dicom/all.blade.php ENDPATH**/ ?>