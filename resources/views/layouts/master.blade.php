...
<html lang="en">
   <head>
      ...
      <title> HCH App- @yield('title') </title>
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                  ...
                  <div class="sidebar-brand-text mx-3"><img src="{{ asset('img/doctor-logo.jpg') }}" class="img-fluid" ></div>
               </a>
...
<!-- ******************ALL REPORTS ADDED FEATURE****************** -->
                        @can('view all patients')
                        <a class="collapse-item" href="{{ route('reports.all') }}">{{ __('sentence.All Reports') }}</a>
                        @endcan
<!-- ******************ALL REPORTS ADDED FEATURE****************** -->
                     </div>
                  </div>
               ...
               <!-- <li class="nav-item">
                  ...
                  <i class="fas fa-fw fa-user-injured"></i>
                  <span>{{ __('sentence.DICOM Patients') }}</span>
                  </a>
                  <div id="collapseDICOMPatient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        @can('view all patients')
                        <a class="collapse-item" href="{{ route('dicom.patient.all') }}">{{ __('sentence.DICOM Patients') }}</a>
                        @endcan
                     </div>
                  </div>
               </li> -->
               ...
               @if(Auth::user()->can('add patient'))
                  ...
                  <div id="collapseDICOMPatient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('view all patients')
                        <a class="collapse-item" href="{{ route('dicom.patient.all') }}">{{ __('sentence.DICOM Patients') }}</a>
                        <a class="collapse-item" href="{{ route('dicom.patient.all.list') }}">{{ __('sentence.DICOM All Patients') }}</a>
                        @endcan
                     </div>
                  </div>
               </li>
               ...
               <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                     <div class="copyright my-auto">
                        <span>Copyright &copy; Powered by <a href="http://egcomputers2014.com/" target="_blank"> EG COMPUTER SOLUTIONS AND ENTERPRISES</a> {{ date('Y') }}</span>
   ...
   <!-- Bootstrap core JavaScript-->
    <script src="{{ asset('dashboard/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
      ...
      <script src="{{ URL::asset('dashboard/js/gijgo.min.js') }}" type="text/javascript"></script>
