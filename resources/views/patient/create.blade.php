...
@endsection
@section('content')
<p><?php echo $patientInfo->lastName ?: "no data"; ?></p>
            ...
            <form method="post" action="{{ route('patient.create') }}" enctype="multipart/form-data">
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                     ...
                     <input type="text" class="form-control" id="dicomID" name="dicomID" value="{{ $patientInfo ? $patientInfo->PatientID : '' }}">
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputEmail4">Last Name<font color="red">*</font></label>
                     <input type="text" class="form-control" id="Name" name="name" value="{{ $patientInfo ? $patientInfo->lastName : '' }}">
                  </div>
                  <div class="form-group col-md-3">
                     <label for="inputEmail4">First Name<font color="red">*</font></label>
                     <input type="text" class="form-control" id="FName" name="first_name" value="{{ $patientInfo ? $patientInfo->firstName : '' }}">
                  </div>
               ...
               <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                     <label for="inputAddress">{{ __('sentence.Patient Height') }}</label>
